            ...
            {STATUSES.map((s) => {
                ...
                return (
                    <button
                        ...
                        className={`px-3 py-1 rounded-full border text-xs font-semibold transition-all ${isActive ? cfg.active : cfg.idle
                            }`}
                    >
                        {cfg.label}
                    </button>
                ...
                <div className="flex gap-2 mb-6">
                    {[
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-sm font-semibold border transition-all ${activeTab === key
