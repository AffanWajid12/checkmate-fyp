        ...
        <section className="bg-background-dark py-24 text-center px-6">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 cursor-pointer">
                    <div onClick={() => window.location.href = "/login"} className="bg-accent text-primary px-8 py-3.5 rounded-full font-bold hover:bg-accent-300 transition-colors w-full sm:w-auto ">
                        Login
                    </div>
                </div>
            </motion.div>
