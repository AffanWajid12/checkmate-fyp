        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                    <button className="text-sm font-medium hover:text-black transition-colors">Log In</button>
            ...
            <main className="max-w-7xl mx-auto px-6 pt-12 pb-20 lg:pt-20 lg:pb-32 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-50 border border-teal-100">
                        ...
                        <span className="text-xs font-semibold text-gray-600 tracking-wide uppercase">New AI Grading Assistant V2.0</span>
                    </div>

                    <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-[1.1]">
                        Checkmate: The LMS that <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-teal-200">grades for you</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <button className="bg-black text-white px-8 py-4 rounded-full text-base font-semibold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl">
                            Get Started for Free
                        </button>
                        <button className="bg-white text-gray-900 border border-gray-200 px-8 py-4 rounded-full text-base font-semibold hover:bg-gray-50 transition-all flex items-center gap-2 shadow-sm">
                ...
                <div className="relative isolate"> {/* Added isolate to manage stacking contexts */}
                    ...
                    {/* Main Card */}
                    <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 max-w-md mx-auto lg:mx-0 lg:ml-auto">
                        <div className="absolute top-0 right-0 p-6">
                            <span className="text-teal-500 font-bold text-sm">+12%</span>
                        </div>
                        <div className="mb-8">
                            <h3 className="text-gray-500 text-sm font-medium mb-1">Grade Dist.</h3>
                            <div className="h-40 flex items-end gap-3 mt-4">
                                <div className="w-1/4 bg-teal-100 rounded-t-lg h-[40%]"></div>
                                <div className="w-1/4 bg-teal-200 rounded-t-lg h-[60%]"></div>
                                <div className="w-1/4 bg-teal-400 rounded-t-lg h-[80%]"></div>
                                <div className="w-1/4 bg-teal-500 rounded-t-lg h-[50%]"></div>
                            </div>
                        </div>

                        {/* Floating Element 1 (Engagement) - Kept inside or moved out depending on preference, kept inside matches your previous code */}
                        <div className="absolute -left-12 bottom-12 bg-white p-4 rounded-2xl shadow-xl border border-gray-50 w-48 hidden md:block">
                            <h4 className="text-xs text-gray-500 mb-2">Engagement</h4>
                            <div className="h-12 w-full">
                                <svg viewBox="0 0 100 40" className="w-full h-full stroke-teal-400 fill-none stroke-2">
                    ...
                    <div className="absolute -right-8 bottom-0 w-48 h-48 md:w-64 md:h-64 z-0 pointer-events-none text-gray-900">
                        <svg
                            viewBox="0 0 24 24"
                    ...
                    <div className="absolute top-12 -right-4 md:-right-12 bg-white p-4 rounded-2xl shadow-lg border border-gray-50 w-40 z-20">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-xs text-gray-400">Completion</span>
                        </div>
                        <div className="text-2xl font-bold text-gray-900 mb-1">94%</div>
                        <div className="w-full bg-gray-100 rounded-full h-1.5">
                            <div className="bg-gradient-to-r from-teal-400 to-green-400 h-1.5 rounded-full w-[94%]"></div>
                        </div>
                    </div>

                    {/* Glow Effect */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-teal-400/10 blur-[100px] -z-10 rounded-full pointer-events-none"></div>
                </div>
            ...
            <section className="bg-gray-50 py-12 border-t border-gray-100">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-8">Trusted by top educational institutions</p>
                    <div className="flex flex-wrap justify-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Logo Placeholders */}
                        {['Univ. of Tech', 'State College', 'Ivy Academy', 'Science Inst.'].map((name) => (
                            <div key={name} className="flex items-center gap-2 font-bold text-xl text-gray-600">
            ...
            <section className="py-24 max-w-7xl mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl font-bold mb-4 text-gray-900">Everything you need to master your classroom</h2>
                    <p className="text-gray-600">Powerful features designed to save you time and improve student outcomes.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white">
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-gray-900">
                            ...
                            <span className="text-teal-400">clarity and speed</span>
                        </h2>
                        ...
                        <a href="#" className="inline-flex items-center gap-2 font-bold text-gray-900 hover:gap-3 transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-gray-900 rounded-3xl p-2 shadow-2xl">
                            <div className="bg-teal-50 rounded-2xl overflow-hidden aspect-[4/3] relative">
                                {/* Mockup Header */}
                                <div className="bg-white px-4 py-3 border-b border-gray-100 flex items-center gap-4">
                                    <div className="w-8 h-8 bg-teal-400 rounded-lg"></div>
                                    <div className="text-sm font-bold text-gray-800">Dashboard Overview</div>
                                    <div className="ml-auto w-8 h-8 rounded-full bg-gray-100"></div>
                                </div>
                                {/* Mockup Sidebar */}
                                <div className="absolute left-0 top-14 bottom-0 w-16 bg-white border-r border-gray-100 flex flex-col items-center py-4 gap-6 text-gray-400">
                                ...
                                <div className="ml-16 p-6 grid grid-cols-2 gap-6 h-full">
                                    <div className="bg-white p-4 rounded-xl shadow-sm">
                                        ...
                                        <div className="flex items-end gap-3 h-32">
                                            <div className="w-1/4 bg-gray-800 h-[60%] rounded-t"></div>
                                            <div className="w-1/4 bg-black h-[80%] rounded-t"></div>
                                            <div className="w-1/4 bg-teal-400 h-[40%] rounded-t"></div>
                                    ...
                                    <div className="bg-white p-4 rounded-xl shadow-sm space-y-3">
                                        ...
                                        {[1, 2, 3].map(i => (
                                            <div key={i} className="flex items-center gap-2">
                                                <div className={`w-2 h-2 rounded-full ${i === 1 ? 'bg-green-500' : i === 2 ? 'bg-green-500' : 'bg-red-500'}`}></div>
            ...
            <section className="bg-black py-24 text-center px-6">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to transform your classroom?</h2>
                <p className="text-gray-400 max-w-2xl mx-auto mb-10 text-lg">
                    Join thousands of educators who are already using Checkmate to teach smarter, not harder.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button className="bg-teal-400 text-black px-8 py-3.5 rounded-full font-bold hover:bg-teal-300 transition-colors w-full sm:w-auto">
                        Start Free Trial
                    </button>
                    <button className="text-white border border-gray-700 px-8 py-3.5 rounded-full font-bold hover:bg-gray-900 transition-colors w-full sm:w-auto">
                        Schedule Demo
                    </button>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1">
                        ...
                        <div className="flex gap-4 text-gray-400">
                            <a href="#" className="hover:text-black"><svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg></a>
                            <a href="#" className="hover:text-black"><svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg></a>
                        </div>
                    </div>
