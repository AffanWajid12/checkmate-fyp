        ...
        <Animated.View style={[styles.overlay, { opacity: overlayOpacity }]}>
          <TouchableWithoutFeedback>
            ...
            >
              ...
              <TouchableOpacity
                style={styles.option}
                onPress={() => closeAnimated(onAddAnnouncement)}
                activeOpacity={0.8}
              >
                ...
                <View style={styles.optionTextContainer}>
                  ...
                  <Text style={styles.optionDescription}>Post important updates to students</Text>
                </View>
              ...
              <TouchableOpacity
                style={styles.option}
                onPress={() => closeAnimated(onAddAssessment)}
                activeOpacity={0.8}
              >
                ...
                <View style={styles.optionTextContainer}>
                  ...
                  <Text style={styles.optionDescription}>Create exam, quiz, or assignment</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                onPress={() => closeAnimated(onAddCourseMaterial)}
                activeOpacity={0.6}
                disabled
              >
                <View style={[styles.iconContainer, { backgroundColor: theme.colors.textTertiary + "20" }]}>
                  <Ionicons name="folder" size={22} color={theme.colors.textTertiary} />
                </View>
                <View style={styles.optionTextContainer}>
                  <Text style={[styles.optionTitle, styles.disabledText]}>Add Course Material</Text>
                  <Text style={[styles.optionDescription, styles.disabledText]}>Coming soon</Text>
                </View>
